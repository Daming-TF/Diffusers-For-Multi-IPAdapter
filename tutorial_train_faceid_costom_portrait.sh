...
accelerate launch --config_file=./default_config_multi_gpu.yaml --main_process_port 29437  tutorial_train_faceid_costom_portrait.py \
    ...
    --data_json_file="/mnt/nfs/file_server/public/mingjiahui/experiments/faceid/train_json/traindata_V1_crop_antelopev2.json" \
    --resolution=512 \
    --train_batch_size=32 \
    --dataloader_num_workers=4 \
    --learning_rate=1e-04 \
    --output_dir="$MODELDIR/experiments/faceid/finetune/base-portrait-antelopev2/20140223-sd15-crop--V1-wo_xformer-scratch_from_step264000" \
    --num_train_epochs=40 \
    --save_steps=2500 \
    --num_tokens=16 \
    --deepface_run_step=2500 \
    --image_encoder='antelopev2'
