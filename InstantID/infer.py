...
if __name__ == "__main__":
    ...
    face_image = Image.open("./data/all_test_data/Tim.jpg")
    face_image.save("./data/InstantID/debug0.jpg")
    face_image = resize_img(face_image)
    face_image.save("./data/InstantID/debug1.jpg")
    ...
    os.makedirs('./data/InstantID', exist_ok=True)
    image.save('./data/InstantID/InstantID_result.jpg')