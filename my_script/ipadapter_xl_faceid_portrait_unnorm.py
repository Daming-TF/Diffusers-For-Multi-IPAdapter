...
def main(args):
    ...
    ip_ckpt = f"{source_dir}/h94--IP-Adapter/h94--IP-Adapter/sdxl_models/ip-adapter-faceid-portrait_sdxl_unnorm.bin"
    device = "cuda"
    app = FaceidAcquirer()
    ...
    if os.path.exists(txt_path):
        with open(txt_path, 'r')as f:
            ...
            assert len(data)==1
        args.prompt = data[0]
    # closeup photo of a man wearing a white shirt in a garden
    prompt = "1 girl, high quality, diffuse light, highly detailed, 4k"  \
...
if __name__ == '__main__':
    ...
    parser.add_argument("--input", type=str, help="input image path", 
        default="/mnt/nfs/file_server/public/mingjiahui/experiments/faceid/test_data/famous/yangmi0.jpg")
    ...
    args.output = os.path.join(os.path.dirname(args.input)+'__faceid_xl_protrait_unnorm', 
            f'ip_{args.ip_scale}-s_scale_{args.s_scale}-'+os.path.basename(args.input))
