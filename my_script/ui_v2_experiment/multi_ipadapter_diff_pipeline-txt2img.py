...
def main(args):
    ...
    pipe_process(image_paths, input_param, \
                 pipe_name="faceid_plusV2_0.8--controlnet0.2", use_control=True)
    ...
    input_param['Unit2']['ip_scale']=0.3
    pipe_process(image_paths, input_param, \
                 pipe_name="faceid_plusV2_0.8--plus_0.3--controlnet0.2", use_control=True)
    ...
    input_param['Unit2']['ip_scale']=0.3
    pipe_process(image_paths, input_param, \
                 pipe_name="faceid_plusV2_0.8--plus_0.3--controlnet0.5", use_control=True)
