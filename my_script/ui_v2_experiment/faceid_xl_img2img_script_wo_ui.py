...
model_dir = "/mnt/nfs/file_server/public/mingjiahui/models/h94--IP-Adapter/h94--IP-Adapter/sdxl_models/"
model_dcit = {
    'faceid':{
        'ip_ckpt':f"{model_dir}/ip-adapter-faceid_sdxl.bin",
        'image_encoder_path':"buffalo_l",
        'lora':f"{model_dir}/ip-adapter-faceid_sdxl_lora.safetensors"
    },
    'base':{
        'ip_ckpt':f"{model_dir}/ip-adapter_sdxl.bin",
        'image_encoder_path':f"{model_dir}/image_encoder",
    },
}
...
def main(args):
    ...
    lora_list = []
    lora_weight = []
    faceid_lora = model_dcit['faceid']['lora']
    ...
    load_model(
        ...
        image_encoder_path=[model_dcit['base']['image_encoder_path'], model_dcit['faceid']['image_encoder_path']],
        ip_ckpt=[model_dcit['base']['ip_ckpt'], model_dcit['faceid']['ip_ckpt']],
        device=device,
        input_pipe=pipe,
        # unet_load=True,
    )
    ...
    for image_path in tqdm(image_paths):
        ...
        input_param['pil_images'][1] = [image]
...
if __name__ == '__main__':
    ...
    parser.add_argument("--json_path", type=str, 
        default="/home/mingjiahui/projects/IpAdapter/IP-Adapter/my_script/ui_v2_experiment/json/api_enhanced_version/iplora_faceid_2ipadpater.json")
    parser.add_argument("--input_dir", type=str, default="/home/mingjiahui/projects/IpAdapter/IP-Adapter/data/all_test_data", help="input image path")
    ...
    args.output = os.path.join(args.input_dir + '_img2img_script_output', f"faceid_scale_{args.faceid_ip_scale}", str(args.iplora)) \
